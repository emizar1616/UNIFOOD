                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:DropDownList ID="ddlRestaurants" CssClass="form-control" runat="server" 
                                                            DataSourceID="SqlDataSource2" DataTextField="Name" DataValueField="RestaurantId"
                                                            AppendDataBoundItems="true" required>
                                                            <asp:ListItem Value="0">Select Restaurant</asp:ListItem>
                                                        </asp:DropDownList>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ForeColor="Red" 
                                                            ErrorMessage="Restaurnat is required" SetFocusOnError="true" Display="Dynamic" 
                                                            ControlToValidate="ddlRestaurants" InitialValue="0">
                                                        </asp:RequiredFieldValidator>
                                                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                                                            ConnectionString="<%$ ConnectionStrings:cs %>" 
                                                            SelectCommand="SELECT [RestaurantId], [Name] FROM [Restaurants]">
                                                        </asp:SqlDataSource>
                                                    </div>
                                                </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Restaurant/Restaurant.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="Food_Ordering_Project.Restaurant.Category" %>
    ...
    <div class="pcoded-inner-content pt-0">
        ...
        <div class="main-body">
            <div class="page-wrapper">
                ...
                <div class="page-body">
                    <h2>Welcome <% Response.Write(Session["username"].ToString()); %></h2>
                    <asp:HiddenField ID="resId" runat="server" Value='0' />

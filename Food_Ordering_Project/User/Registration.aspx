            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            <asp:TextBox ID="Textteacher" runat="server" TextMode="MultiLine" CssClass="form-control"
                                placeholder="If you are teacher, enter your teacher card number"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">

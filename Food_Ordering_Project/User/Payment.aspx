                        ...
                        <div class="card-header">
                            <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                                ...
                                <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                                    ...
                                    <li class="nav-item"><a data-toggle="pill" href="#teacher" class="nav-link "><% Response.Write(Session["teacher"]); %></a></li>
                            ...
                            <div class="tab-content">
                                    ...
                                    <div role="form">
                                        <div class="form-group">
                                            <label for="txtName">
                                                ...
                                                <h6>Card Owner <% Response.Write(Session["teacher"]); %></h6>
                                            </label>
                                ...
                                <!-- End -->
                                <!-- Use Teacher Card -->
                                <div id="teacher" class="tab-pane fade pt-3">
                                    <div class="form-group">
                                        <label for="txtCODAddress">
                                            <h6>Delivery Address</h6>
                                        </label>
                                        <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" placeholder="Delivery Address"
                                            TextMode="MultiLine"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Address is required" ForeColor="Red"
                                            ControlToValidate="TextBox1" Display="Dynamic" SetFocusOnError="true" ValidationGroup="paypal">

                                        </asp:RequiredFieldValidator>
                                    </div>
                                    <p>
                                        <asp:LinkButton ID="lbCod2Submit" runat="server" CssClass="btn btn-info" ValidationGroup="paypal" OnClick="lbCod2Submit_Click">
                                            <i class="fa fa-cart-arrow-down mr-2"></i>Confirm Order</asp:LinkButton>
                                    </p>
                                    <p class="text-muted">
                                        You are using teacher card as a payment option
                                    After completing the payment process, you can check your updated order status.
                                    </p>
                                </div>
                                <!-- End -->
